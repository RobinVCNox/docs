...
If you read the endpoint documentation of [/devices](/api-docs/hp/asset-info/get-devices) you will
...
We recommend you to read the explanation at [historical consumption](/guides/full-control-package#2-1-historical-consumption) first.
