...
<Tabs>
  ...
  <Tab title="Manufacturer/EMS">
    ...
    <Note>
    A [manufacturer-specific link session endpoint](/api-docs/manufacturer-integration/manufacturer/create-manufacturer-link-session) exists but will be deprecated in the future. We recommend not using it.
    </Note>
