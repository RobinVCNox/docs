...
<Update label="August 2026">
  ...
  * The Full NOX Control Package and Supplier Control Package API references have been merged into a single **HP** API reference, since they covered the same heat pump endpoints under different distribution models.
